...
const PlaceTrade = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!window.confirm("Are you sure you want to place this trade?")) {
       return;
   }
        setLoading(true);
    ...
    return (
        <div className=" bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex justify-center rounded-md items-center p-10">

            <div className="w-full max-w-4xl bg-gray-800/80 backdrop-blur-md border border-gray-700 text-white rounded-2xl shadow-2xl p-6">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-3 pr-36 rounded-lg bg-gray-700 focus:ring-2 focus:ring-blue-500"
                            />
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="Enter %"
                                className="w-full p-3 pr-12 rounded-lg bg-gray-700 focus:ring-2 focus:ring-blue-500 outline-none transition"
                            />
                        ...
                        <div className="flex flex-col gap-2 bg-gray-700/50 border border-gray-600 p-4 rounded-xl">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full p-3 pr-16 rounded-lg bg-gray-800 focus:ring-2 focus:ring-blue-500 outline-none transition"
                                />
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:scale-[1.02] transition py-3 rounded-lg font-semibold"
                        >
